...
export class UpdateRuleManagedNotificationComponent implements OnInit {
  dataFake:any={
  ...
  save(){
    let me=this;
    let newUsers=me.users.filter(user=>user.checked);
  ...
  checkAllCheckBox(ev) {
	...
	isAllCheckBoxChecked() {
		return this.users.every(p => p.checked);
	}
}
